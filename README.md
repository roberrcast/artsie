...
The Open Gallery is a modern, high-performance web application that brings the collection of the Art Institute of Chicago to your fingertips. Built with React 19 and TypeScript, it offers a seamless experience for exploring masterpieces, exhibitions, and artist biographies.
...
1. Clone the repository:
    ```bash
    git clone https://github.com/roberrcast/art-project.git
    ```
...
All data and images are provided by the [Art Institute of Chicago API](https://api.artic.edu/docs/). This project was built for educational purposes to showcase modern frontend architecture, type safety, and rigorous testing patterns.
